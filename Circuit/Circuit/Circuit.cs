...
namespace Circuit
{
    ...
    {
        //储存电路图所有的边
        private List<ArcNode<Branch>> _arcs = new List<ArcNode<Branch>>();
        ...
        /// <param name="vexID1">负极点id</param>
        /// <param name="vexID2">正极点id</param>
        /// <param name="value">复合支路的值</param>
        /// <returns></returns>
        public Branch Add(int vexID1, int vexID2, Branch value)
        {
            value.Type = BranchType.Complex;
            return AddBranch(vexID1, vexID2, value);
        }
